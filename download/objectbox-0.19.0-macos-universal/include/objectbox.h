...
typedef void obx_log_callback(OBXLogLevel log_level, const char *message, size_t message_size,
                              void *user_data);
...
OBX_C_API obx_err
obx_model_entity(OBX_model *model, const char *name, obx_schema_id entity_id, obx_uid entity_uid);
...
OBX_C_API obx_err
obx_model_property_relation(OBX_model *model, const char *target_entity, obx_schema_id index_id,
                            obx_uid index_uid);
...
/// @param index_uid Used to identify relations between versions of the model. Must be globally unique.
OBX_C_API obx_err
obx_model_property_index_id(OBX_model *model, obx_schema_id index_id, obx_uid index_uid);
...
OBX_C_API obx_err
obx_model_relation(OBX_model *model, obx_schema_id relation_id, obx_uid relation_uid,
...
OBX_C_API void
obx_model_last_relation_id(OBX_model *model, obx_schema_id relation_id, obx_uid relation_uid);
...
OBX_C_API obx_err obx_model_entity_last_property_id(OBX_model *model, obx_schema_id property_id,
...
OBX_C_API obx_err
obx_bytes_lazy_get(OBX_bytes_lazy *bytes, const void **out_bytes, size_t *out_size);
...
OBX_C_API obx_err
obx_opt_model_bytes_direct(OBX_store_options *opt, const void *bytes, size_t size);
...
/// Note: this value should typically be low to keep latency low and prevent accumulating too much operations.
OBX_C_API void
obx_opt_async_pre_txn_delay4(OBX_store_options *opt, uint32_t delay_micros, uint32_t delay2_micros,
...
OBX_C_API void
obx_opt_async_post_txn_delay5(OBX_store_options *opt, uint32_t delay_micros, uint32_t delay2_micros,
...
OBX_C_API void
obx_opt_log_callback(OBX_store_options *opt, obx_log_callback *callback, void *user_data);
...
OBX_C_API void
obx_opt_backup_restore(OBX_store_options *opt, const char *backup_file, uint32_t flags);
...
OBX_C_API OBX_store *
obx_store_attach_or_open(OBX_store_options *opt, bool check_matching_options, bool *out_attached);
...
OBX_C_API obx_err
obx_store_back_up_to_file(OBX_store *store, const char *backup_file, uint32_t backup_flags);
...
OBX_C_API obx_err
obx_txn_abort(OBX_txn *txn);  // Internal note: will make more sense once we introduce obx_txn_reset

OBX_C_API obx_err
obx_txn_data_size(OBX_txn *txn, uint64_t *out_committed_size, int64_t *out_size_change);
...
OBX_C_API obx_err
obx_cursor_put4(OBX_cursor *cursor, obx_id id, const void *data, size_t size, OBXPutMode mode);
...
OBX_C_API obx_id
obx_cursor_put_object4(OBX_cursor *cursor, void *data, size_t size, OBXPutMode mode);
...
/// @returns NULL if the operation failed, see functions like obx_last_error_code() to get error details
OBX_C_API OBX_bytes_array *
obx_cursor_backlinks(OBX_cursor *cursor, obx_schema_id entity_id, obx_schema_id property_id,
                     obx_id id);

/// @returns NULL if the operation failed, see functions like obx_last_error_code() to get error details
OBX_C_API OBX_id_array *
obx_cursor_backlink_ids(OBX_cursor *cursor, obx_schema_id entity_id, obx_schema_id property_id,
                        obx_id id);

OBX_C_API obx_err
obx_cursor_rel_put(OBX_cursor *cursor, obx_schema_id relation_id, obx_id source_id,
                   obx_id target_id);

OBX_C_API obx_err
obx_cursor_rel_remove(OBX_cursor *cursor, obx_schema_id relation_id, obx_id source_id,
                      obx_id target_id);

/// @returns NULL if the operation failed, see functions like obx_last_error_code() to get error details
OBX_C_API OBX_id_array *
obx_cursor_rel_ids(OBX_cursor *cursor, obx_schema_id relation_id, obx_id source_id);
...
OBX_C_API obx_err
obx_cursor_ts_min_max(OBX_cursor *cursor, obx_id *out_min_id, int64_t *out_min_value,
...
OBX_C_API obx_err
obx_cursor_ts_min_max_range(OBX_cursor *cursor, int64_t range_begin, int64_t range_end,
...
OBX_C_API obx_err
obx_box_visit_many(OBX_box *box, const OBX_id_array *ids, obx_data_visitor *visitor,
                   void *user_data);
...
/// @see obx_box_put_object() for a variant not requiring reserving IDs
OBX_C_API obx_err
obx_box_put5(OBX_box *box, obx_id id, const void *data, size_t size, OBXPutMode mode);
...
OBX_C_API obx_err
obx_box_put_many(OBX_box *box, const OBX_bytes_array *objects, const obx_id *ids, OBXPutMode mode);
...
OBX_C_API obx_err
obx_box_put_many5(OBX_box *box, const OBX_bytes_array *objects, const obx_id *ids, OBXPutMode mode,
...
OBX_C_API OBX_id_array *
obx_box_get_backlink_ids(OBX_box *box, obx_schema_id property_id, obx_id id);
...
OBX_C_API obx_err
obx_box_rel_put(OBX_box *box, obx_schema_id relation_id, obx_id source_id, obx_id target_id);

/// Remove a standalone relation entry between two objects.
/// See obx_box_rel_put() for parameters documentation.
OBX_C_API obx_err
obx_box_rel_remove(OBX_box *box, obx_schema_id relation_id, obx_id source_id, obx_id target_id);
...
/// @returns resulting IDs representing objects in this Box, or NULL in case of an error
OBX_C_API OBX_id_array *
obx_box_rel_get_backlink_ids(OBX_box *box, obx_schema_id relation_id, obx_id id);
...
OBX_C_API obx_err
obx_expired_objects_remove(OBX_txn *txn, obx_schema_id entity_id, size_t *out_removed_count);
...
/// @returns OBX_NOT_FOUND if no objects are stored
OBX_C_API obx_err
obx_box_ts_min_max(OBX_box *box, obx_id *out_min_id, int64_t *out_min_value, obx_id *out_max_id,
                   int64_t *out_max_value);
...
/// @returns OBX_NOT_FOUND if no objects are stored in the given range
OBX_C_API obx_err
obx_box_ts_min_max_range(OBX_box *box, int64_t range_begin, int64_t range_end, obx_id *out_min_id,
...
OBX_C_API obx_err
obx_async_put5(OBX_async *async, obx_id id, const void *data, size_t size, OBXPutMode mode);
...
OBX_C_API obx_qb_cond
obx_qb_equals_string(OBX_query_builder *builder, obx_schema_id property_id, const char *value,
                     bool case_sensitive);

OBX_C_API obx_qb_cond
obx_qb_not_equals_string(OBX_query_builder *builder, obx_schema_id property_id, const char *value,
                         bool case_sensitive);

OBX_C_API obx_qb_cond
obx_qb_contains_string(OBX_query_builder *builder, obx_schema_id property_id, const char *value,
                       bool case_sensitive);

/// For container types (e.g. string vector or flex), this looks for a element that equals the given string.
OBX_C_API obx_qb_cond
obx_qb_contains_element_string(OBX_query_builder *builder, obx_schema_id property_id,
...
OBX_C_API obx_qb_cond
obx_qb_contains_key_value_string(OBX_query_builder *builder, obx_schema_id property_id,
                                 const char *key, const char *value, bool case_sensitive);

OBX_C_API obx_qb_cond
obx_qb_starts_with_string(OBX_query_builder *builder, obx_schema_id property_id,
                          const char *value, bool case_sensitive);

OBX_C_API obx_qb_cond
obx_qb_ends_with_string(OBX_query_builder *builder, obx_schema_id property_id, const char *value,
                        bool case_sensitive);

OBX_C_API obx_qb_cond
obx_qb_greater_than_string(OBX_query_builder *builder, obx_schema_id property_id,
                           const char *value, bool case_sensitive);

OBX_C_API obx_qb_cond
obx_qb_greater_or_equal_string(OBX_query_builder *builder, obx_schema_id property_id,
                               const char *value, bool case_sensitive);

OBX_C_API obx_qb_cond
obx_qb_less_than_string(OBX_query_builder *builder, obx_schema_id property_id, const char *value,
                        bool case_sensitive);

OBX_C_API obx_qb_cond
obx_qb_less_or_equal_string(OBX_query_builder *builder, obx_schema_id property_id,
                            const char *value, bool case_sensitive);
...
OBX_C_API obx_qb_cond
obx_qb_any_equals_string(OBX_query_builder *builder, obx_schema_id property_id, const char *value,
                         bool case_sensitive);

// Integral conditions -------------------------

OBX_C_API obx_qb_cond
obx_qb_equals_int(OBX_query_builder *builder, obx_schema_id property_id, int64_t value);

OBX_C_API obx_qb_cond
obx_qb_not_equals_int(OBX_query_builder *builder, obx_schema_id property_id, int64_t value);

OBX_C_API obx_qb_cond
obx_qb_greater_than_int(OBX_query_builder *builder, obx_schema_id property_id, int64_t value);

OBX_C_API obx_qb_cond
obx_qb_greater_or_equal_int(OBX_query_builder *builder, obx_schema_id property_id, int64_t value);

OBX_C_API obx_qb_cond
obx_qb_less_than_int(OBX_query_builder *builder, obx_schema_id property_id, int64_t value);

OBX_C_API obx_qb_cond
obx_qb_less_or_equal_int(OBX_query_builder *builder, obx_schema_id property_id, int64_t value);

OBX_C_API obx_qb_cond
obx_qb_between_2ints(OBX_query_builder *builder, obx_schema_id property_id, int64_t value_a,
                     int64_t value_b);

/// Note that all values are copied and thus do not need to be maintained by the calling code.
OBX_C_API obx_qb_cond
obx_qb_in_int64s(OBX_query_builder *builder, obx_schema_id property_id, const int64_t values[],
                 size_t count);
...
/// Note that all values are copied and thus do not need to be maintained by the calling code.
OBX_C_API obx_qb_cond
obx_qb_in_int32s(OBX_query_builder *builder, obx_schema_id property_id, const int32_t values[],
                 size_t count);
...
OBX_C_API obx_qb_cond
obx_qb_greater_than_double(OBX_query_builder *builder, obx_schema_id property_id, double value);

OBX_C_API obx_qb_cond
obx_qb_greater_or_equal_double(OBX_query_builder *builder, obx_schema_id property_id,
                               double value);

OBX_C_API obx_qb_cond
obx_qb_less_than_double(OBX_query_builder *builder, obx_schema_id property_id, double value);

OBX_C_API obx_qb_cond
obx_qb_less_or_equal_double(OBX_query_builder *builder, obx_schema_id property_id, double value);

OBX_C_API obx_qb_cond
obx_qb_between_2doubles(OBX_query_builder *builder, obx_schema_id property_id, double value_a,
                        double value_b);

// Bytes (blob) conditions ---------------------

OBX_C_API obx_qb_cond
obx_qb_equals_bytes(OBX_query_builder *builder, obx_schema_id property_id, const void *value,
                    size_t size);

OBX_C_API obx_qb_cond
obx_qb_greater_than_bytes(OBX_query_builder *builder, obx_schema_id property_id,
                          const void *value, size_t size);

OBX_C_API obx_qb_cond
obx_qb_greater_or_equal_bytes(OBX_query_builder *builder, obx_schema_id property_id,
                              const void *value, size_t size);

OBX_C_API obx_qb_cond
obx_qb_less_than_bytes(OBX_query_builder *builder, obx_schema_id property_id, const void *value,
                       size_t size);

OBX_C_API obx_qb_cond
obx_qb_less_or_equal_bytes(OBX_query_builder *builder, obx_schema_id property_id,
                           const void *value, size_t size);
...
OBX_C_API obx_qb_cond
obx_qb_relation_count_property(OBX_query_builder *builder, obx_schema_id relation_entity_id,
...
OBX_C_API obx_qb_cond
obx_qb_all(OBX_query_builder *builder, const obx_qb_cond conditions[], size_t count);

/// Combine conditions[] to a new condition using operator OR (any).
OBX_C_API obx_qb_cond
obx_qb_any(OBX_query_builder *builder, const obx_qb_cond conditions[], size_t count);
...
OBX_C_API obx_err
obx_qb_order(OBX_query_builder *builder, obx_schema_id property_id, uint32_t flags);

/// Create a link based on a property-relation (many-to-one)
OBX_C_API OBX_query_builder *
obx_qb_link_property(OBX_query_builder *builder, obx_schema_id property_id);

/// Create a backlink based on a property-relation used in reverse (one-to-many)
OBX_C_API OBX_query_builder *
obx_qb_backlink_property(OBX_query_builder *builder, obx_schema_id source_entity_id,
                         obx_schema_id source_property_id);

/// Create a link based on a standalone relation (many-to-many)
OBX_C_API OBX_query_builder *
obx_qb_link_standalone(OBX_query_builder *builder, obx_schema_id relation_id);

/// Create a backlink based on a standalone relation (many-to-many, reverse direction)
OBX_C_API OBX_query_builder *
obx_qb_backlink_standalone(OBX_query_builder *builder, obx_schema_id relation_id);
...
///        Must be a date type (e.g. PropertyType_Date or PropertyType_DateNano).
OBX_C_API OBX_query_builder *
obx_qb_link_time(OBX_query_builder *builder, obx_schema_id linked_entity_id,
...
//----------------------------------------------
OBX_C_API obx_err
obx_query_cursor_visit(OBX_query *query, OBX_cursor *cursor, obx_data_visitor *visitor,
                       void *user_data);
...
OBX_C_API obx_err
obx_query_cursor_remove(OBX_query *query, OBX_cursor *cursor, uint64_t *out_count);
...
//----------------------------------------------
OBX_C_API obx_err
obx_query_param_string(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                       const char *value);

OBX_C_API obx_err
obx_query_param_2strings(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                         const char *value, const char *value2);

OBX_C_API obx_err
obx_query_param_strings(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                        const char *const values[], size_t count);

OBX_C_API obx_err
obx_query_param_int(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                    int64_t value);

OBX_C_API obx_err
obx_query_param_2ints(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                      int64_t value_a, int64_t value_b);

OBX_C_API obx_err
obx_query_param_int64s(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                       const int64_t values[], size_t count);

OBX_C_API obx_err
obx_query_param_int32s(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                       const int32_t values[], size_t count);

OBX_C_API obx_err
obx_query_param_double(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                       double value);

OBX_C_API obx_err
obx_query_param_2doubles(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                         double value_a, double value_b);

OBX_C_API obx_err
obx_query_param_bytes(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id,
                      const void *value, size_t size);
...
OBX_C_API size_t
obx_query_param_get_type_size(OBX_query *query, obx_schema_id entity_id, obx_schema_id property_id);
...
//----------------------------------------------
OBX_C_API obx_err
obx_query_param_alias_string(OBX_query *query, const char *alias, const char *value);

OBX_C_API obx_err
obx_query_param_alias_strings(OBX_query *query, const char *alias, const char *const values[],
                              size_t count);

OBX_C_API obx_err obx_query_param_alias_int(OBX_query *query, const char *alias, int64_t value);

OBX_C_API obx_err
obx_query_param_alias_2ints(OBX_query *query, const char *alias, int64_t value_a, int64_t value_b);

OBX_C_API obx_err
obx_query_param_alias_int64s(OBX_query *query, const char *alias, const int64_t values[],
                             size_t count);

OBX_C_API obx_err
obx_query_param_alias_int32s(OBX_query *query, const char *alias, const int32_t values[],
                             size_t count);

OBX_C_API obx_err obx_query_param_alias_double(OBX_query *query, const char *alias, double value);

OBX_C_API obx_err
obx_query_param_alias_2doubles(OBX_query *query, const char *alias, double value_a, double value_b);

OBX_C_API obx_err
obx_query_param_alias_bytes(OBX_query *query, const char *alias, const void *value, size_t size);
...
/// @note not all methods support distinct, those that don't will return an error
OBX_C_API obx_err
obx_query_prop_distinct_case(OBX_query_prop *query, bool distinct, bool case_sensitive);
...
OBX_C_API obx_err
obx_query_prop_avg(OBX_query_prop *query, double *out_average, int64_t *out_count);
...
OBX_C_API obx_err
obx_query_prop_avg_int(OBX_query_prop *query, int64_t *out_average, int64_t *out_count);
...
OBX_C_API obx_err
obx_query_prop_min(OBX_query_prop *query, double *out_minimum, int64_t *out_count);
...
///                  E.g. if an index is used, it will be set to 0 or -1, instead of the actual count of objects.
OBX_C_API obx_err
obx_query_prop_max(OBX_query_prop *query, double *out_maximum, int64_t *out_count);
...
///                  E.g. if an index is used, it will be set to 0 or -1, instead of the actual count of objects.
OBX_C_API obx_err
obx_query_prop_min_int(OBX_query_prop *query, int64_t *out_minimum, int64_t *out_count);
...
///                  E.g. if an index is used, it will be set to 0 or -1, instead of the actual count of objects.
OBX_C_API obx_err
obx_query_prop_max_int(OBX_query_prop *query, int64_t *out_maximum, int64_t *out_count);
...
/// @returns OBX_ERROR_NUMERIC_OVERFLOW if the result does not fit into an int64_t
OBX_C_API obx_err
obx_query_prop_sum_int(OBX_query_prop *query, int64_t *out_sum, int64_t *out_count);
...
OBX_C_API OBX_string_array *
obx_query_prop_find_strings(OBX_query_prop *query, const char *value_if_null);
...
/// @returns NULL if the operation failed, see functions like obx_last_error_code() to get error details
OBX_C_API OBX_int64_array *
obx_query_prop_find_int64s(OBX_query_prop *query, const int64_t *value_if_null);

/// Return an array of ints stored as the given property across all objects matching the query.
/// @param value_if_null value that should be used in place of NULL values on object fields;
///     if value_if_null=NULL is given, objects with NULL values of the specified are skipped
/// @returns NULL if the operation failed, see functions like obx_last_error_code() to get error details
OBX_C_API OBX_int32_array *
obx_query_prop_find_int32s(OBX_query_prop *query, const int32_t *value_if_null);

/// Return an array of ints stored as the given property across all objects matching the query.
/// @param value_if_null value that should be used in place of NULL values on object fields;
///     if value_if_null=NULL is given, objects with NULL values of the specified are skipped
/// @returns NULL if the operation failed, see functions like obx_last_error_code() to get error details
OBX_C_API OBX_int16_array *
obx_query_prop_find_int16s(OBX_query_prop *query, const int16_t *value_if_null);

/// Return an array of ints stored as the given property across all objects matching the query.
/// @param value_if_null value that should be used in place of NULL values on object fields;
///     if value_if_null=NULL is given, objects with NULL values of the specified are skipped
/// @returns NULL if the operation failed, see functions like obx_last_error_code() to get error details
OBX_C_API OBX_int8_array *
obx_query_prop_find_int8s(OBX_query_prop *query, const int8_t *value_if_null);

/// Return an array of doubles stored as the given property across all objects matching the query.
/// @param value_if_null value that should be used in place of NULL values on object fields;
///     if value_if_null=NULL is given, objects with NULL values of the specified are skipped
/// @returns NULL if the operation failed, see functions like obx_last_error_code() to get error details
OBX_C_API OBX_double_array *
obx_query_prop_find_doubles(OBX_query_prop *query, const double *value_if_null);

/// Return an array of int stored as the given property across all objects matching the query.
/// @param value_if_null value that should be used in place of NULL values on object fields;
///     if value_if_null=NULL is given, objects with NULL values of the specified are skipped
/// @returns NULL if the operation failed, see functions like obx_last_error_code() to get error details
OBX_C_API OBX_float_array *
obx_query_prop_find_floats(OBX_query_prop *query, const float *value_if_null);
...
OBX_C_API obx_err
obx_tree_cursor_get_raw(OBX_tree_cursor *cursor, const char *path, const void **data, size_t *size,
...
OBX_C_API obx_err
obx_tree_cursor_put_raw(OBX_tree_cursor *cursor, const char *path, void *leaf_data,
...
OBX_C_API obx_err
obx_tree_cursor_consolidate_node_conflicts(OBX_tree_cursor *cursor, size_t *out_consolidated_count);
...
OBX_C_API OBX_tree_leaves_info *
obx_tree_cursor_get_child_leaves_info(OBX_tree_cursor *cursor, const char *path);
...
OBX_C_API OBXPropertyType
obx_tree_leaves_info_type(OBX_tree_leaves_info *leaves_info, size_t index);
...
///        specific context).
OBX_C_API obx_err
obx_tree_async_put_raw(OBX_tree *tree, const char *path, void *leaf_data, size_t leaf_data_size,
...
OBX_C_API obx_err
obx_bytes_array_set(OBX_bytes_array *array, size_t index, const void *data, size_t size);
